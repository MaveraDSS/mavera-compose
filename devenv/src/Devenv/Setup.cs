...
public static class ReposRootClaudeMd
{
    ...
    public static string Render(Manifest manifest)
    {
        ...
        var lines = new List<string>
        {
            ...
            "  `/dss:repro <ticket>` shows a bug on the unfixed code, `/dss:verify <ticket>` checks the stack with evidence",
            "  (before/after for bugs), `/dss:ticket <ticket>` works a ticket end to end.",
            "",
